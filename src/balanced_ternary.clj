...
;; Balanced ternary is a way of representing numbers. Unlike 
;; the prevailing binary representation, a balanced ternary 
;; integer is in base 3, and each digit can have the values 
;; 1, 0, or −1.
...
;; Provide ways to convert to and from text strings, 
;; using digits '+', '-' and '0' (unless you are already using 
;; strings to represent balanced ternary; but see requirement 5).
...
;; Test case With balanced ternaries a from string "+-0++0+", 
;; b from native integer -436, c "+-++-":
